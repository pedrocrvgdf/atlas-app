...
(function () {
  ...
  function estilo() {
    return `<style>
      ...
      .cons-tl { background:linear-gradient(90deg, #0f3a5c 0%, #16456b 34%, #1a5d84 68%, #1f7ba3 100%);
        border-radius:12px; padding:10px 16px 8px; min-height:54px; box-sizing:border-box;
        display:flex; align-items:center; gap:16px;
        box-shadow:0 1px 2px rgba(20,50,80,.05), 0 12px 28px -22px rgba(16,42,66,.5); }
      ...
      .cons-tl-acao { flex-shrink:0; font-family:inherit; font-size:12px; font-weight:700; color:#16456b; background:#fff;
        border:none; border-radius:8px; padding:8px 13px; cursor:pointer; white-space:nowrap; box-shadow:0 2px 6px rgba(10,40,66,.2); }
      ...
      .cons-tl-pino { width:24px; height:24px; border-radius:7px; padding:0; cursor:pointer; display:flex; align-items:center; justify-content:center;
        background:#fff; box-shadow:0 3px 7px rgba(10,40,66,.3); position:relative; z-index:2; transition:transform var(--t-fast); }
      ...
      .cons-tl-balao { position:absolute; top:60px; z-index:9; width:max-content; min-width:246px; max-width:340px; box-sizing:border-box; flex-direction:column; gap:7px;
        background:#fff; border-radius:10px; padding:11px 13px; box-shadow:0 8px 22px rgba(10,40,66,.34); pointer-events:none; }
      ...
      .cons-tl-b-titulo { font-size:13px; font-weight:700; color:#14384f; white-space:nowrap; }
      .cons-tl-b-linhas { display:flex; flex-direction:column; gap:3px; }
      .cons-tl-b-linhas span { font-size:11.5px; color:#5b6c7c; white-space:nowrap; font-variant-numeric:tabular-nums; }
      .cons-tl-bd { position:fixed; inset:0; background:rgba(15,37,68,.5); z-index:100050; display:flex; align-items:flex-start; justify-content:center; padding:64px 24px; }
      .cons-tl-modal { width:520px; max-width:96vw; background:#fff; border-radius:16px; box-shadow:0 24px 60px -20px rgba(15,37,68,.45); display:flex; flex-direction:column; }
      .cons-tl-mod-head { padding:20px 24px 16px; border-bottom:1px solid #edf2f6; display:flex; flex-direction:column; gap:10px; }
      ...
      .cons-tl-x { width:30px; height:30px; border-radius:8px; border:none; background:#f2f6f9; color:#5b6c7c; font-size:17px; line-height:1; cursor:pointer; }
      .cons-tl-x:hover { background:#e5edf3; color:#14384f; }
      .cons-tl-mod-titulo { font-size:20px; font-weight:700; color:#14384f; letter-spacing:-0.01em; }
      .cons-tl-mod-cod { font-size:13px; color:#5b6c7c; }
      ...
      .cons-tl-mod-cardi { background:#f7fafc; border:1px solid #e8eff5; border-radius:10px; padding:11px 13px; display:flex; flex-direction:column; gap:2px; }
      .cons-tl-mod-cardi span { font-size:10px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:#90a1ae; }
      .cons-tl-mod-cardi strong { font-size:15px; font-weight:700; color:#14384f; }
      ...
      .cons-tl-aviso span { font-size:12.5px; line-height:1.5; color:#5b6c7c; }
      .cons-tl-mod-pe { padding:14px 24px; border-top:1px solid #edf2f6; display:flex; align-items:center; gap:9px; }
      .cons-tl-btn-pri { font-family:inherit; font-size:12.5px; font-weight:700; color:#fff; background:#1c6fa8; border:none; border-radius:9px; padding:11px 18px; cursor:pointer; }
      .cons-tl-btn-pri:hover { background:#14547f; }
      .cons-tl-btn-sec { font-family:inherit; font-size:12.5px; font-weight:700; color:#5b6c7c; background:transparent; border:1px solid #dfe8f0; border-radius:9px; padding:10px 16px; cursor:pointer; }
      .cons-tl-btn-sec:hover { border-color:#c3d5e2; color:#14384f; }
      .cons-tl-mod-nota { margin-left:auto; font-size:11.5px; color:#90a1ae; }
      .cons-tl-pino:focus-visible, .cons-tl-acao:focus-visible { outline:2px solid #2f8fc4; outline-offset:2px; }
