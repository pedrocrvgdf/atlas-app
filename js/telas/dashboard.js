...
function renderGraficoDonut(repasse) {
  const fontes = [
    { chave: 'laudos',         label: 'Laudos',         cor: '#005073', valor: repasse.laudos          || 0 },
    { chave: 'periodos',       label: 'Períodos',       cor: '#189AD3', valor: repasse.periodos        || 0 },
    { chave: 'fellow',         label: 'Fellow',         cor: '#15a34a', valor: repasse.fellow          || 0 },
    { chave: 'qvis_calculado', label: 'QVIS calculado', cor: '#107DAC', valor: repasse.qvis_calculado  || 0 },
...
function injetarEstilosDashboard() {
  ...
  style.textContent = `
    ...
    .vg-hero::before {
      ...
      background: radial-gradient(circle, rgba(24, 154, 211, 0.12) 0%, transparent 70%);
      pointer-events: none;
    }
    .vg-hero-label {
      font-size: 11px;
    ...
    .vg-meta-faint { color: rgba(24, 154, 211, 0.55); font-style: italic; }
    ...
    .vg-bar-group:hover .vg-bar {
      filter: drop-shadow(0 3px 8px rgba(0, 80, 115, 0.30));
      opacity: 0.92;
    }
