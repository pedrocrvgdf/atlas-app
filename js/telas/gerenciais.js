...
(function () {
  ...
  function corStatus(nome) {
    ...
    if (n.indexOf('GLOSA') >= 0) return '#a15646';               // rel-tag-glosa
    if (n.indexOf('AJUSTE') >= 0 || n.indexOf('PRODU') >= 0) return '#585d62'; // rel-tag-atlas
    if (n.indexOf('DESEMPENHO') >= 0) return '#3f6489';         // rel-tag-desemp
