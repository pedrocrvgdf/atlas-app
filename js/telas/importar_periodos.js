...
(function () {
  ...
  function _injetarCSS() {
    ...
    style.textContent = `
      ...
      .impper-mes-atribuir-linha small { color: var(--ink-faint, #5B736C); }
      .impper-input-mes {
      ...
      .impper-tag-novo { background: #EAF4FB; color: #06283A; }   /* V863 */
      .impper-tag-aviso { background: #E1EFF6; color: #854F0B; }
