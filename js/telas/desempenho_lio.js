  ...
  function renderRodapeTabelaV493(linhas, cfg) {
    ...
    return `
      <tr>
        ...
        `}
        ${cfg.ocultarRepasse ? '' : `<td class="num mono atlas-rep"><strong>R$ ${fmt(totalRepasse)}</strong></td>`}<!-- V965: total de Repasse em #3f6489 -->
      </tr>
    `;
  }
  ...
  function cssLio() {
    return `
      ...
      .lio-btn-info {
        ...
        line-height: 1;
        box-shadow: 0 1px 3px rgba(89, 128, 166,0.08);
      }
      .lio-btn-info:hover {
        background: #3f6489;
        color: white;
        ...
        box-shadow: 0 3px 8px rgba(63, 100, 137,0.30);
      }
      .lio-btn-info-ativo {
        background: #3f6489;
        color: white;
      ...
      .lio-popover-regras {
        ...
        max-width: 720px;
        box-shadow: 0 4px 14px rgba(29, 31, 32,0.10);
      ...
      /* ── V727: fileira de filtros 20C (padrão do OPME, prefixo do LIO) ── */
        ...
        margin-bottom: 14px;   /* V731: respiro antes dos cards */
          ...
          .lio-sb-celwrap:not(:last-child) .lio-sb-cel { border-right: 1px solid #f7f8fa; }
          .lio-sb-cel {
            flex: 1; min-width: 0;
          ...
          .lio-sb-cel:hover, .lio-sb-cel.ativo, .lio-sb-cel.aberta { background: #fafbfc; }
          .lio-sb-cel:focus-visible { outline: 2px solid #3f6489; outline-offset: 2px; }
          .lio-sb-tile {
            width: 28px; height: 28px; border-radius: 8px; flex-shrink: 0;
            display: flex; align-items: center; justify-content: center;
            background: #f0f5f9; color: #585d62;
          }
          .lio-sb-cel.ativo .lio-sb-tile, .lio-sb-cel.aberta .lio-sb-tile { background: #eef2f6; color: #46688c; }
          ...
          .lio-sb-cel.ativo .lio-sb-val { font-weight: 700; color: #3a5877; }
          .lio-sb-chev { color: #8a9096; flex-shrink: 0; display: flex; transition: transform 140ms; }
          ...
          .lio-sb-busca::placeholder { color: #8a9096; }
          .lio-sb-busca:focus { border-color: #3f6489; }
          .lio-sb-lista { max-height: 262px; overflow-y: auto; padding: 6px; }
          .lio-sb-lista::-webkit-scrollbar { width: 8px; }
          .lio-sb-lista::-webkit-scrollbar-track { background: #f7f8fa; }
          .lio-sb-lista::-webkit-scrollbar-thumb { background: #e4eaf1; border-radius: 4px; }
          .lio-sb-it {
            display: flex; align-items: center; gap: 10px;
            height: 38px; padding: 0 8px; border-radius: 8px; cursor: pointer;
            font-size: 13px; color: #3a5877;
          }
          .lio-sb-it:hover, .lio-sb-it.foco { background: #f7f8fa; }
          .lio-sb-it.sel { background: #f7f8fa; font-weight: 700; }
          ...
          .lio-sb-ck { color: #46688c; display: flex; }
          .lio-sb-chip {
      ...
      .lio-mes-select {
        ...
        box-shadow: 0 1px 3px rgba(29, 31, 32,0.10), inset 0 1px 0 rgba(255,255,255,0.4);
        cursor: pointer;
        box-sizing: border-box;
        transition: background-color 150ms, color 150ms, border-color 150ms, box-shadow 150ms, transform 150ms, opacity 150ms;
      }
      .lio-mes-select:hover { border-color: var(--accent); box-shadow: 0 2px 6px rgba(63, 100, 137,0.18); }
      ...
      .lio-confirm-icon-perigo {
        background: rgba(63, 100, 137, 0.18);
        color: #3f6489;
      }
      .lio-confirm-titulo {
        font-size: 17px;
      ...
      .lio-confirm-btn-ok:hover {
        ...
        box-shadow: 0 4px 12px rgba(63, 100, 137, 0.35);
      }
      .lio-confirm-btn-ok:focus-visible,
      .lio-confirm-btn-cancelar:focus-visible {
        outline: 2px solid rgba(63, 100, 137, 0.5);
        outline-offset: 2px;
      }
      ...
      .lio-confirm-btn-perigo:hover {
        background: #823232;
        border-color: #823232;
        box-shadow: 0 4px 12px rgba(161, 86, 70, 0.35);
      }
      @keyframes lioFadeIn {
        from { opacity: 0; }
        to   { opacity: 1; }
      ...
      .lio-aj-nota-toggle {
        ...
        border: 1px solid rgba(63, 100, 137, 0.20);
        border-radius: 8px;
        font-size: 11px;
        line-height: 1.5;
        color: var(--ink-soft);
      ...
      .lio-aj-pai-tab-ativa {
        ...
        border-color: rgba(63, 100, 137, 0.30);
        border-bottom-color: #3f6489;
      }
      ...
      .lio-conv-flagado-card {
        background: var(--bg-sunken);
        border: 1px solid var(--border);
        border-left: 4px solid var(--success, #4f8a5b);
        border-radius: 6px;
        overflow: hidden;
      }
      .lio-conv-flagado-sem-tabela {
        border-left-color: var(--warning, #3f6489);
      }
      ...
      .lio-conv-flagado-head[data-conv-toggle]:hover {
        background: rgba(63, 100, 137, 0.05);
      }
      ...
      .lio-conv-flagado-importar:hover {
        background: #2BA8A8;
        transform: translateY(-1px);
        box-shadow: 0 2px 8px rgba(63, 100, 137, 0.30);
      }
      ...
      .lio-conv-consolidado-painel {
        background: linear-gradient(180deg, rgba(63, 100, 137, 0.04) 0%, var(--bg) 100%);
        border-bottom: 1px solid var(--border);
        padding: 14px 18px;
      }
      ...
      .lio-conv-consolidado-chip {
        ...
        gap: 5px;
        background: white;
        border: 1px solid rgba(63, 100, 137, 0.30);
        color: var(--ink);
      ...
      .lio-conv-consolidado-chip-remover:hover {
        background: rgba(161, 86, 70, 0.15);
        color: var(--danger, #a15646);
        opacity: 1;
      }
      ...
      .lio-conv-tabela tbody tr:hover {
        background: rgba(63, 100, 137, 0.03);
      }
      ...
      .lio-conv-chip-termo {
        ...
        font-weight: 600;
        letter-spacing: 0.02em;
        border: 1px solid rgba(63, 100, 137, 0.25);
        white-space: nowrap;
        transition: background-color 150ms, color 150ms, border-color 150ms, box-shadow 150ms, transform 150ms, opacity 150ms;
      }
      ...
      .lio-conv-chip-edit-input {
        ...
        min-width: 100px;
        max-width: 180px;
        box-shadow: 0 0 0 2px rgba(63, 100, 137, 0.15);
      }
      .lio-conv-chip-add {
        background: transparent;
        border: 1px dashed var(--border);
      ...
      .lio-kpi:hover {
        box-shadow: 0 6px 16px rgba(29, 31, 32,0.14);
      ...
      .lio-kpi-label {
        ...
        letter-spacing: 0.06em;
        margin-bottom: 4px;
        color: #1d1f20; /* V849: título dos cards totalizadores (variante destaque mantém a própria) */
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
      }
      ...
      .lio-kpi-destaque-num {
        font-size: 15px;
        font-weight: 800;
        color: #3f6489;   /* V965: era #46688c (V646: era #C24A1F) */
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
      }
      ...
      /* V646: os RÓTULOS dos cards recebiam #0F6E56 de uma regra GLOBAL de
         ...
         layout é #3a5877 — override escopado, injetado depois do style.css. */
      .main .lio-kpi :is([class*="-label"], [class*="-titulo"], [class*="-lbl"], .label) { color: #3a5877 !important; }
      .lio-kpi-verde .lio-kpi-faixa  { background: #3a5877; }   /* V646 (era #5980a6) */
      .lio-kpi-verde .lio-kpi-label  { color: #3a5877; }
      .lio-kpi-verde .lio-kpi-valor  { color: #3a5877; }
      ...
      .lio-kpi-bege .lio-kpi-faixa  { background: #3a5877; }   /* V646 (era #5980a6) */
      .lio-kpi-bege .lio-kpi-label  { color: #3a5877; }
      .lio-kpi-bege .lio-kpi-valor  { color: #3a5877; }
      ...
      .lio-kpi-card-destaque {
        ...
        border-color: #5980a6;
        box-shadow: 0 4px 12px rgba(89, 128, 166,.2);
      }
      .lio-kpi-card-destaque .lio-kpi-faixa { display: none; }
      .lio-kpi-card-destaque .lio-kpi-label { color: #585d62; }
      .lio-kpi-card-destaque .lio-kpi-valor { color: #1d1f20; }   /* V709 (era #3a5877) */
      .lio-kpi-card-destaque .lio-kpi-subtot .mono { color: #3f6489; font-weight: 700; }   /* V709 · V965: era #46688c */
      ...
      .lio-kpi-card-destaque .lio-kpi-sub   { color: #e4eaf1; }
      ...
      .lio-filt-input {
        ...
        box-sizing: border-box;
        font-family: inherit;
        box-shadow: 0 1px 3px rgba(29, 31, 32,0.08), inset 0 1px 0 rgba(255,255,255,0.5);
        transition: background-color 150ms, color 150ms, border-color 150ms, box-shadow 150ms, transform 150ms, opacity 150ms;
      }
      .lio-filt-input:hover { border-color: var(--accent); }
      .lio-filt-input:focus {
        border-color: var(--accent);
        box-shadow: 0 0 0 3px rgba(63, 100, 137,0.18), inset 0 1px 0 rgba(255,255,255,0.5);
      }
      ...
      .lio-combo-dropdown {
        ...
        border: 1px solid var(--border);
        border-radius: 8px;
        box-shadow: 0 10px 28px rgba(29, 31, 32,0.18),
                    0 2px 6px rgba(29, 31, 32,0.08);
        max-height: 280px;
        overflow-y: auto;
        font-size: 12px;
      ...
      .lio-combo-opt-selecionado {
        background: rgba(63, 100, 137, 0.14);
        color: var(--accent);
        font-weight: 700;
      }
      .lio-combo-opt-selecionado:hover {
        background: rgba(63, 100, 137, 0.22);
      }
      .lio-combo-vazio {
        padding: 12px 10px;
        text-align: center;
      ...
      .lio-th-popover {
        ...
        border: 1px solid var(--border);
        border-radius: 8px;
        box-shadow: 0 6px 20px rgba(29, 31, 32, 0.15);
        z-index: 100;
        display: flex;
        flex-direction: column;
        text-transform: none;
      ...
      .lio-aj-sub-aba-ativa {
        background: var(--bg-sunken);
        color: var(--primary);
        box-shadow: 0 1px 2px rgba(29, 31, 32,0.08);
      }
      .lio-aj-sub-aba-meta {
        font-size: 9.5px;
        opacity: 0.7;
      ...
      .lio-aj-chip-qtd {
        ...
        color: var(--primary);
        border-color: rgba(89, 128, 166, 0.18);
      }
      .lio-aj-chip-qtd strong { font-weight: 800; }
      .lio-aj-chip-valor {
        background: rgba(63, 100, 137, 0.10);
        color: #5980a6;
        border-color: rgba(63, 100, 137, 0.28);
        font-weight: 700;
      }
      .lio-aj-macro-body {
        padding: 4px 0;
      ...
      .lio-aba:hover:not(.lio-aba-ativa) {
        ...
        transform: translateY(-1px);
        box-shadow: 0 3px 8px rgba(29, 31, 32,0.08);
      }
      .lio-aba-ativa {
        background: var(--primary) !important;
        color: white !important;
        border-color: var(--primary) !important;
        box-shadow: 0 3px 10px rgba(89, 128, 166, 0.28), 0 1px 3px rgba(89, 128, 166, 0.20) !important;
      }
      ...
      .lio-aba-bullet-conv { background: #5980a6; }
      .lio-aba-bullet-part { background: #3f6489; }
      ...
      .lio-adic-consol-sw { position: relative; display: inline-flex; align-items: center; justify-content: center;
        ...
        background: #1d1f20; color: #fff; border: none; cursor: pointer; user-select: none;
        transition: background-color .15s ease, box-shadow .15s ease; }
      .lio-adic-consol-sw:hover { background: rgba(29, 31, 32, .9); }
      .lio-adic-consol-sw:focus-within { box-shadow: 0 0 0 2px var(--bg-elevated, #fff), 0 0 0 4px var(--accent-vivid, #5980a6); }
      ...
      .lio-adic-sug { position: absolute; top: calc(100% + 4px); left: 0; right: 0; z-index: 40; background: var(--bg-raised, #fff); border: 1px solid var(--border); border-radius: 8px; box-shadow: 0 8px 22px rgba(29, 31, 32,0.14); max-height: 240px; overflow-y: auto; }
      ...
      .lio-adic-mini-rm { color: var(--danger, #a15646); }
      ...
      .lio-adic-data-paga { background: #e9f1e9; color: #4f8a5b; border-radius: 99px;
        padding: 3px 10px; font-size: 11px; font-weight: 700; white-space: nowrap; }
      .lio-adic-data-fundo { position: fixed; inset: 0; background: rgba(29, 31, 32, .45);
      ...
      .lio-adic-tabela th { position: sticky; top: 0; z-index: 5; background: var(--primary, #5980a6); color: #fff; text-align: left; padding: 9px 10px; font-size: 10.5px; letter-spacing: 0.05em; text-transform: uppercase; white-space: nowrap; box-shadow: inset 0 -2px 0 rgba(0,0,0,0.22); }
      ...
      .lio-aba-ativa .lio-aba-bullet {
        ...
        box-shadow: 0 0 0 3px rgba(63, 100, 137, 0.20);
      }
      ...
      .lio-aba-ativa .lio-aba-badge {
        ...
        color: white;
        border-color: var(--accent);
        box-shadow: 0 1px 3px rgba(63, 100, 137, 0.40);
      }
      ...
      .lio-painel {
        ...
        overflow: hidden;
        box-shadow: 0 4px 14px rgba(29, 31, 32,0.08);
      }
      .lio-painel-head {
        padding: 10px 14px;
        background: var(--bg-sunken);
      ...
      .lio-badge-sem-opme {
        ...
        color: var(--danger, #a15646);
        border: 1px solid rgba(161, 86, 70, 0.25);
        font-size: 9px;
        font-weight: 700;
        padding: 2px 6px;
        border-radius: 4px;
      ...
      .lio-teste-remover:hover { background: #a15646; color: white; border-color: #a15646; }
      ...
      .lio-tabela tbody tr.lio-linha-desabilitada > td {
        opacity: 0.55;
        background: rgba(161, 86, 70, 0.06) !important;
      }
      ...
      .lio-dup-toggle-on {
        ...
        color: var(--success, #4f8a5b);
        border-color: rgba(79, 138, 91, 0.30);
      }
      .lio-dup-toggle-on:hover { background: rgba(79, 138, 91, 0.20); }
      .lio-dup-toggle-off {
        background: rgba(161, 86, 70, 0.10);
        color: var(--danger, #a15646);
        border-color: rgba(161, 86, 70, 0.30);
      }
      .lio-dup-toggle-off:hover { background: rgba(161, 86, 70, 0.18); }
      .lio-dup-info {
        font-size: 9px;
        color: var(--ink-faint);
        font-family: var(--font-mono);
      ...
      .lio-menu-exp {
        ...
        border-radius: 12px;
        box-shadow: 0 14px 36px rgba(29, 31, 32, 0.22), 0 3px 8px rgba(29, 31, 32, 0.10);
        padding: 6px;
      ...
      .lio-matriz-toggle {
        ...
        padding: 3px;
        gap: 2px;
        box-shadow: inset 0 1px 2px rgba(29, 31, 32,0.06);
      }
      .lio-matriz-opt {
        display: inline-flex;
        align-items: center;
      ...
      .lio-matriz-opt-ativa {
        ...
        color: white;
        box-shadow: 0 1px 3px rgba(29, 31, 32,0.20);
      }
      ...
      .lio-tabela thead th {
        ...
        letter-spacing: 0.05em;
        color: #FFFFFF;
        border-bottom: 2px solid #3a5877;
        position: sticky;
        top: 0;
      ...
      .lio-th-teste {
        background: rgba(63, 100, 137, 0.06) !important;
        text-align: center;
      }
      ...
      /* Zebra — V717: mesmas cores da aba ADICIONAL (branco + azul
         var(--bg-sunken)); antes era um bege rgba(250, 251, 252,.45) e as abas
      ...
      .lio-badge-pct {
        display: inline-block;
        background: rgba(63, 100, 137, 0.10);   /* V965: era rgba(89, 128, 166,.08) */
        color: #3f6489;                          /* V965: era var(--primary) */
        font-size: 8.5px;
        font-weight: 700;
        letter-spacing: 0.04em;
        padding: 1px 5px;
      ...
      /* ── Drilldown (#2) ── */
      .lio-linha-aberta { background: rgba(63, 100, 137, 0.08) !important; }
      ...
      .lio-drill-exec { border-left: 3px solid #5980a6; }
       ...
       *
       * O style.css pinta o tfoot td de #3a5877 com !important
      ...
      .lio-diag-vazio { border-left: 4px solid #46688c; }
      .lio-diag-cadeia { margin-top: 6px; font-size: 11px; color: var(--ink-faint, #585d62); }
      .lio-vazio {
        padding: 60px 30px;
        text-align: center;
        color: var(--ink-faint);
      ...
      .lio-aviso-flag-vazio {
        background: linear-gradient(180deg, rgba(63, 100, 137, 0.06) 0%, var(--bg-elevated) 100%);
        border-color: rgba(63, 100, 137, 0.30);
      }
      .lio-aviso-flag-orfao {
        background: linear-gradient(180deg, rgba(63, 100, 137, 0.08) 0%, var(--bg-elevated) 100%);
        border-color: rgba(63, 100, 137, 0.30);
      }
      ...
      /* V730: hover SEM troca de cor (pedido do usuário — "Mapear nomes"
         mantinha #3f6489 e virava outro tom no mouse) — fica só o leve
         levantar + sombra. */
      ...
      .lio-aviso-flag-orfao .lio-aviso-flag-btn:hover {
        background: #3f6489;
        box-shadow: 0 3px 10px rgba(63, 100, 137, 0.35);
      }
