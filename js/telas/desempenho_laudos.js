...
App.telas['desempenho-laudos'] = function () {
  ...
  function renderAbas(linhas) {
    ...
    return `
      <div class="laudos-abas">
        ${aba('PACOTE',   getRot('aba_PACOTE'),   '#3f6489')}
        ${aba('IMPRESSO', getRot('aba_IMPRESSO'), '#5980a6')}
        ${aba('EXTERNO',  getRot('aba_EXTERNO'),  '#3f6489')}
      </div>
    `;
  }
  ...
  function cssLaudos() {
    return `
      ...
      .laud-sb-celwrap:not(:last-child) .laud-sb-cel { border-right: 1px solid #f7f8fa; }
      .laud-sb-cel {
        flex: 1; min-width: 0;
      ...
      .laud-sb-cel:hover, .laud-sb-cel.ativo, .laud-sb-cel.aberta { background: #fafbfc; }
      .laud-sb-cel:focus-visible { outline: 2px solid #3f6489; outline-offset: 2px; }
      .laud-sb-tile {
        width: 28px; height: 28px; border-radius: 8px; flex-shrink: 0;
        display: flex; align-items: center; justify-content: center;
        background: #f0f5f9; color: #585d62;
      }
      .laud-sb-cel.ativo .laud-sb-tile, .laud-sb-cel.aberta .laud-sb-tile { background: #eef2f6; color: #46688c; }
      ...
      .laud-sb-cel.ativo .laud-sb-val { font-weight: 700; color: #3a5877; }
      .laud-sb-chev { color: #8a9096; flex-shrink: 0; display: flex; transition: transform 140ms; }
      ...
      .laud-sb-busca::placeholder { color: #8a9096; }
      .laud-sb-busca:focus { border-color: #3f6489; }
      .laud-sb-lista { max-height: 262px; overflow-y: auto; padding: 6px; }
      .laud-sb-lista::-webkit-scrollbar { width: 8px; }
      .laud-sb-lista::-webkit-scrollbar-track { background: #f7f8fa; }
      .laud-sb-lista::-webkit-scrollbar-thumb { background: #e4eaf1; border-radius: 4px; }
      .laud-sb-it {
        display: flex; align-items: center; gap: 10px;
        height: 38px; padding: 0 8px; border-radius: 8px; cursor: pointer;
        font-size: 13px; color: #3a5877;
      }
      .laud-sb-it:hover, .laud-sb-it.foco { background: #f7f8fa; }
      .laud-sb-it.sel { background: #f7f8fa; font-weight: 700; }
      ...
      .laud-sb-ck { color: #46688c; display: flex; }
      .laud-sb-chip {
      ...
      .laudos-btn-importar:hover {
        ...
        box-shadow: 0 4px 12px rgba(89, 128, 166, 0.20);
      }
      ...
      .laudos-kpi-verde .laudos-kpi-faixa { background: #5980a6; }
      .laudos-kpi-verde .laudos-kpi-valor { color: var(--ink); }

      .laudos-kpi-bege {
        background: linear-gradient(135deg, #eef2f6 0%, #F5D9A6 100%);
        color: #5980a6;
      }
      .laudos-kpi-bege .laudos-kpi-faixa { background: #3f6489; }
      ...
      .laudos-kpi-destaque {
        background: linear-gradient(135deg, #5980a6 0%, #0F2925 100%);
        color: #D9B475;
      }
      .laudos-kpi-destaque .laudos-kpi-faixa { background: #3f6489; }
      .laudos-kpi-destaque .laudos-kpi-valor { color: #5980a6; }
      ...
      .laudos-aba-ativa {
        ...
        color: white;
        border-color: var(--primary);
        box-shadow: 0 3px 10px rgba(89, 128, 166, 0.28);
      }
      .laudos-aba-bullet {
      ...
      /* V968: zebra PADRÃO da ferramenta (branco + azul var(--bg-sunken) #eef2f6,
      ...
      .laudos-tabela tbody tr.laudos-zebra td {
        background: var(--bg-sunken, #eef2f6);
      }
      ...
      .laudos-linha-particular td {
        background: rgba(63, 100, 137, 0.05) !important;
      }
      ...
      /* V969: no Laudos a linha Total NÃO usa a barra preta global (#3a5877,
         style.css V181): fundo branco, rótulo na cor normal e só o valor de
         repasse em #3f6489 (.atlas-rep). Escopo: só este módulo. */
      ...
      .main .laudos-tabela tfoot td.atlas-rep * { color: #3f6489 !important; }

      /* ───────── DRILLDOWN EXTERNO ───────── */
      .laudos-ext-medico-row td {
        background: #eef2f6 !important;   /* V968: era o degradê bege #F0EBDF→#E8E0CB */
      ...
      .laudos-ext-medico-row td.atlas-rep strong { color: #3f6489; }
      ...
      .laudos-ext-chip-qtd {
        ...
        color: #3f6489;   /* V969: era #5980a6 — só o texto muda, a pílula fica */
        padding: 2px 8px;
        border-radius: 999px;
        font-size: 10.5px;
        font-weight: 800;
      ...
      .laudos-ext-detalhe td {
        background: #FFFFFF !important;   /* V968: era o creme rgba(250, 251, 252,.6) */
        font-size: 11px;
        color: var(--ink-soft);
      ...
      .laudos-ajuste-tabela tbody tr:hover td { background: rgba(250, 251, 252, 0.5); }
      ...
      .laudos-ajuste-input:focus {
        border-color: var(--primary);
        box-shadow: 0 0 0 3px rgba(89, 128, 166, 0.10);
      }
      ...
      .laudos-tag-impresso {
        ...
        color: var(--primary);
        border: 1px solid rgba(89, 128, 166, 0.30);
      }
      .laudos-tag-externo {
