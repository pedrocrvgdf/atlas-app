      ...
      if (mostrar) {
        if (!el) {
          ...
          el.style.cssText = 'position:fixed;right:16px;bottom:16px;z-index:100060;' +
            'background:#06283A;color:#fff;font:600 12px/1 Inter Tight,-apple-system,sans-serif;' +
            'padding:10px 14px;border-radius:10px;box-shadow:0 6px 18px rgba(10,40,66,.35);pointer-events:none';
