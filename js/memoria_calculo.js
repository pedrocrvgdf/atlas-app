...
(function () {
  ...
  function estilos() {
    ...
    s.textContent = `
      ...
      [data-mem].mem-cel-ativa { background: #EAF4FB !important; box-shadow: inset 0 0 0 1px #9CCBE6; border-radius: 4px; }
      ...
      .atlas-mem-popover { position: fixed; z-index: 4300; width: 460px; max-width: calc(100vw - 20px); max-height: min(78vh, 640px); overflow: hidden auto;
        background: #fff; border-radius: 14px; box-shadow: 0 18px 44px rgba(6,40,58,.26), 0 0 0 1px #DDE7E3; font-size: 12.5px; color: #042222;
      ...
      .atlas-mem-popover.fixado { box-shadow: 0 18px 44px rgba(6,40,58,.34), 0 0 0 2px #107DAC; }
      /* V997: o título do cartão saiu do #06283A chapado para o DEGRADÊ padrão
      ...
      .mem-head { display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; padding: 12px 14px 10px;
        background-image: linear-gradient(90deg, #16456b 0%, #1d6d92 34%, #2a9fc4 68%, #4fd3ec 100%); color: #fff; }
      ...
      /* V997: o valor do cabeçalho e o selo PAGO saíram do verde-menta
         ...
         #189AD3, a cor de repasse da ferramenta. */
      ...
      .mem-sec-tit { font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: .6px; color: #107DAC; margin-bottom: 4px; }
      .mem-it { display: grid; grid-template-columns: 132px 1fr; gap: 8px; padding: 3px 0; line-height: 1.35; }
      .mem-rot { color: #56645E; font-weight: 600; }
      .mem-val { color: #06283A; word-break: break-word; }
      .mem-val small { color: #56645E; font-size: 11px; }
      .mem-val b { font-weight: 800; color: #189AD3; }
